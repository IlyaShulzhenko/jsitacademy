...
function validate(element){
    ...
    if (!value) {
        if (!element.nextSibling) {
            const errorElelemt = document.createElement('div');
        
            errorElelemt.textContent = "error";
            element.after(errorElelemt);
        }
    } else {
...
// let forms = document.qxuerySelectorAll('form');
// forms.forEach(item => {
